...
export function EditActuaryDialog({ actuary, isOpen, onOpenChange, onSuccess }: EditActuaryDialogProps) {
            ...
            <Dialog open={isOpen} onOpenChange={onOpenChange}>
                <DialogContent className="sm:max-w-[500px] bg-card">
                    <DialogHeader>
                        ...
                        <EditActuaryForm actuary={actuary} onClose={handleClose} onSuccess={onSuccess} />
                </DialogContent>
            </Dialog>
        );
    }
