...
import { RadioGroupItem } from "@/components/ui/radio-group"; // Ako je ovo odvojeno
import { Label } from "@/components/ui/label"; // Pretpostavljam da je Label komponenta takođe u tvojoj aplikaciji
